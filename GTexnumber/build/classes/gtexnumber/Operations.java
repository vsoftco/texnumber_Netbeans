...
public class Operations {
    ...
    public void OutputLog(JTextArea log_area) throws IOException {
        ...
        while (itr.hasNext()) {
            ...
            log_area.append(itr.next() + " -> " + itrNew.next() +
                    System.getProperty("line.separator"));
        }
        
        log_area.append(System.getProperty("line.separator")+"Input pattern: \\label{" + m_inputPattern +
                System.getProperty("line.separator"));
        log_area.append("Output pattern: " + m_outputPattern +
                System.getProperty("line.separator"));
        log_area.append("Total of " + m_labelList.size() + " labels." +
                System.getProperty("line.separator"));
        log_area.append("Altered " + (int) (m_lines) + " lines.");        

        SimpleDateFormat dateFormat = new SimpleDateFormat("HH:mm:ss yy/MM/dd ");
        Date date = new java.util.Date();

        log_area.append(System.getProperty("line.separator")+
